...
- **모니터:** 실제 NVDA 60거래일 캔들이 배속으로 흘러간다. 한 바퀴는 약 40초이고, 끝나면 무한 반복한다.
...
- **엔딩 (손실일 때 10초):** 모니터에 최종 성적표가 뜨고, 초파리가 몸을 기울여 확인한 뒤 → 깜짝 놀라 → 카메라 쪽으로 돌아앉아 두 팔로 머리를 감싸고 눈물을 흘리며 흐느낀다. 카메라는 천천히 초파리 쪽으로 다가간다.
